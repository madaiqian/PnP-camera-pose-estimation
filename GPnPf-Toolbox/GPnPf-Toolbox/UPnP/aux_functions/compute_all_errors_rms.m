function [error_rec,error_repr,error_Linf,error_rot,error_trans]=compute_all_errors_rms(Xw,U,Xc_true,R_true,T_true,Xc,R,T,A)
...
error_Linf=Linfinity_error_usingRT(Xw,U,R,T,A);
